...
return false;
	...
	alert("수정이 완료되었습니다.")
	location.href="${contextPath}/admin_board_notice.do";
}
}
...
<ul class="my_gnb">
	...
	<form role="form" method="post" action="${contextPath}/admin_board_notice_update_action.do" onsubmit="return _onSubmit();">
        <main>
        ...
        <input type="hidden" id="n_no" name="n_no" value="${list.n_no}" />
            <div class="order_list21">
					...
					<div class="title_wrap">
							<h2 class="tit_txt" style="text-align:center">공지사항 수정</h2>
					</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
  								...
  								<select name="n_type" onchange="categoryChange(this)" class="form-control onlyHangul">
    								<option>선택</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" value="관리자" id="prodName" data-rule-required="true" maxlength="30" readonly>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" name="n_name" id="prodmake" data-rule-required="true"  maxlength="40">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">            
                             <textarea name="n_content" rows="10" cols="65" class="form-control onlyNumber" maxlength="4000"></textarea>                                            
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10" align="center">
                        ...
                        <button type="button" class="btn btn-outline-dark" onclick="location='admin_board_notice.do'">취소하기</button>
                    </div>
                </div>
