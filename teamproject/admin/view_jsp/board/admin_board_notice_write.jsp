...
<ul class="my_gnb">
        ...
        <div class="title_wrap"><h2 class="tit_txt">관리자 페이지</h2></div> <hr>
            ...
            <form class="form-horizontal form_align" role="form" method="post" action="admin_board_notice_write.do">              
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="n_name" class="form-control" id="prodmake" data-rule-required="true"  maxlength="40">
                    </div>
                </div>
       ...
       <div class="div-1">
						<button type="button" class="btn btn-outline-dark" onclick="location='admin_board_notice.do'">돌아가기</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
