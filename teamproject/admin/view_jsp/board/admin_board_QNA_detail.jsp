...
function deleteConfirm(){
	...
	alert("삭제가 완료되었습니다.")
	location.href="${contextPath}/admin_board_QNA_delete.do?q_no=${list.q_no}";
	}
	}
        ...
        <form role="frm" method="post">
            <div class="order_list21">
						...
						<div class="title_wrap">
							<h2 class="tit_txt" style="text-align:center">Q&A</h2>
						</div>
						...
						<div class="listTable21">
							<table border="0" cellspacing="0" cellpadding="0" width="100%" class="myP_Ttype1">
								...
								<thead>
									...
									<tr><th>답변 내용</th><td><c:out value="${list.q_reply}"/></td></tr>																
									</thead>
						...
						<div class="div-1">
						<br><br>
						<a href="${contextPath}/admin_board_QNA_receive_write.do?q_no=${list.q_no}" class="btn btn-outline-dark">답변쓰기</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;					
