...
<div class="slideshow-container" style="height:600px">
    ...
    <div class="container">
        <div class="row justify-content-center" style="float:left; width:50%; height:500px">
            <div class="col-lg-5 col-md-8 align-item-center">
                <div class="border" style="height:460px">
                    <h3 class="bg-gray p-4" style="text-align:center; margin-bottom: 0px;">회원, 비회원 주문조회</h3>
                    <form action="nonmember.do">
                        <fieldset class="p-4">
                        	<h4 style="margin-top: 25px;">이름</h4>
                            <input type="text" id="order_name" name="order_name" placeholder="Name" class="border p-3 w-100 my-2" style="height:55px;">              
                            <h4 style="margin-top: 20px;">휴대폰 번호</h4>
                            <input type="number" id= "order_phone" name="order_phone" placeholder="Number" class="border p-3 w-100 my-2" style="height:55px;">
