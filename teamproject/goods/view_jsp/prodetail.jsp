    ...
    <div class="review_list" style="position:relative;">  
      <div class="review_list_inner">
											...
											<div class="average">
												...
												<br>												
												<strong><c:out value="${goods.productStar}"/></strong>
     ...
     <table class="table_style01" cellpadding="0" cellspacing="0">
	<colgroup>
		<col width="5%">
		<col width="7%">
		<col width="30%">
	...
	<thead>
		<tr>
			...
			<c:choose>
				...
				<tr align="center">
					<td><c:out value="${list.re_num}"></c:out></td>
					<td>
					<c:out value="${list.re_star}"></c:out>
					
					</td>
						<td>
						<a href="${contextPath}/prodetail_review_detail.do?productNum=${goods.productNum}&re_num=${list.re_num}">
						<c:out value="${list.re_content}"/>
						</a>
						</td>
					<td><c:out value="${list.user_id}"></c:out></td>
					<td><c:out value="${list.re_regdate}"></c:out></td>
