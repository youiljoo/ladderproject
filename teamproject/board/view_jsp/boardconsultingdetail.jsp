...
alert("삭제하였습니다.")
location.href="${contextPath}/board/consulting/delete?c_no=${list.c_no}";
}
}
...
<section class="section">
	...
	<form name="frm" method="post">
						...
						<table class="n-table table-row">
							<tbody>
								<tr class="n-same-row">
									<th scope="row">번호</th>
									<td>
                                      <input type="text" class="m-input" name="c_no" value="${list.c_no}" readonly>
									</td>
								</tr>
								...
								<tr class="n-same-row">
									...
									<td>
                                      <input type="text" class="m-input" name="user_phone" value="${list.c_type}" readonly>
									</td>
								</tr>
								...
								<tr>
									<th scope="row">제목</th>
									<td>
										<input type="text" class="n-input" name="c_name" value="${list.c_name}" readonly>
									</td>
								</tr>
								<tr class="n-same-row">
									<th scope="row">문의내용</th>
									<td>
										<textarea name="c_content" cols="100" rows="20" class="n-input" readonly>${list.c_content}</textarea>
									</td>
								</tr>
		...
		<a href="${contextPath}/board/consulting/update?c_no=${list.c_no}" class="btn btn-success">수정</a>
