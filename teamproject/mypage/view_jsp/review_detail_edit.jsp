         ...
         <div class="title_wrap"><h2 class="tit_txt">주문현황</h2></div> 
            ...
            <div class="order_list21">
						<div class="title_wrap">
							<h2 class="tit_txt2">상품 후기 수정</h2>						
						</div>
						<form method="post" action="${contextPath}/review_detail_edit.do" accept-charset="utf-8" enctype="multipart/form-data">
					...
					<table border="0" cellspacing="0" cellpadding="0" width="100%" class="myP_Ttype1">	
							<tbody>
								<tr>
									<th>상품번호</th>
									<td>
										<input type="hidden" name="re_num" value="${order.re_num }">
										<input type="text" name="productNum" value="${order.productNum}" style="text-align:center" readonly>
									</td>
								</tr>
								<tr>
									<th>상품이름</th>
									<td>
										<input type="text" name="productName" value="${order.productName}" style="text-align:center" readonly>
									</td>
								</tr>
								<tr>
									<th>별점 선택</th>
								...
								<tr>
									<th>작성자</th>
									<td>
										<input type="text" name="user_id" value="${order.user_id}" style="text-align:center" readonly>
									</td>
								</tr>
								...
								<tr>
									<th>내용</th>
									<td>
										<textarea name="re_content" cols="80" rows="20">${order.re_content }</textarea>
									</td>
								</tr>
								<tr>
									<th>사진 첨부
